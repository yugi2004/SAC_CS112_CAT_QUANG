...
public class Automobile7 {
	private int door = 0;
	private int cylinders = 0;
	private String color = null;
	private int transmission = 0;
	private String name = null;
	public Automobile7(String color, int door, int cylinders, int trans)
	{
		this.door=door;
	...
	public Automobile7 (int door, int cylinders, int trans )
	{
		this.door=door;
		this.cylinders=cylinders;
		transmission=trans;
	}
	public Automobile7 (int door, int cylinders)
	{
		this.door=door;
		this.cylinders=cylinders;
	}
